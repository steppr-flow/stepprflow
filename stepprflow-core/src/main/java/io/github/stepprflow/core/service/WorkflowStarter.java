...
public interface WorkflowStarter {
    ...
    /**
     * Forward a message to a remote workflow topic without requiring local registration.
     * Use this when the workflow handler is defined in another service.
     *
     * @param topic   The workflow topic (handled by another service)
     * @param payload The payload object
     * @return The execution ID
     */
    String forward(String topic, Object payload);

    /**
     * Forward a message to a remote workflow topic with metadata.
     *
     * @param topic    The workflow topic (handled by another service)
     * @param payload  The payload object
     * @param metadata Additional metadata
     * @return The execution ID
     */
    String forward(String topic, Object payload, Map<String, Object> metadata);
}
