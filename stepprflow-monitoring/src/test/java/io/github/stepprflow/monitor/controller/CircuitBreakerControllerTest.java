...
import io.github.stepprflow.monitor.dto.CircuitBreakerStatus;
...
class CircuitBreakerControllerTest {
    ...
    class GetConfig {
        ...
        void shouldReturnConfig() {
            ...
            ResponseEntity<io.github.stepprflow.monitor.dto.CircuitBreakerConfig> response = controller.getConfig();
