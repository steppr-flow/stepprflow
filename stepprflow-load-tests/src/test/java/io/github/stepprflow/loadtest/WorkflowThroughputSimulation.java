package io.github.stepprflow.loadtest;
 ...
 * <p>
 * Run with: mvn gatling:test -pl stepprflow-load-tests -Pload-test -Dgatling.simulationClass=io.github.stepprflow.loadtest.WorkflowThroughputSimulation
 * <p>
 * Prerequisites:
